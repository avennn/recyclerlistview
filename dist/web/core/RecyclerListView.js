...
var RecyclerListView = /** @class */ (function (_super) {
    ...
    function RecyclerListView(props, context) {
        ...
        _this._onViewContainerSizeChange = function (dim, index) {
            ...
            if (_this.props.debugHandlers &&
                _this.props.debugHandlers.resizeDebugHandler) {
                ...
                if (this.props.forceNonDeterministicRendering) {
                    if (this._virtualRenderer) {
                        ...
                        if (layoutManager) {
                            ...
                            this.props.contextProvider.save(uniqueKey +
                                Constants_1.Constants.CONTEXT_PROVIDER_LAYOUT_KEY_SUFFIX, JSON.stringify({ layoutArray: layoutsToCache }));
                        }
                    }
                }
            }
    ...
    RecyclerListView.prototype.getCurrentScrollOffset = function () {
        ...
        return viewabilityTracker
            ? viewabilityTracker.getLastActualOffset()
            : 0;
    };
    ...
    RecyclerListView.prototype.renderCompat = function () {
        ...
        return (React.createElement(ScrollComponent_1.default, __assign({ ref: function (scrollComponent) {
                ...
                : 0, renderAheadOffset: this.getCurrentRenderAheadOffset() }), this._generateRenderStack()));
    };
        ...
        if (props.contextProvider) {
            ...
            if (uniqueKey) {
                ...
                if (typeof offset === 'number' && offset > 0) {
                    ...
                    props.contextProvider.remove(uniqueKey +
                        Constants_1.Constants.CONTEXT_PROVIDER_OFFSET_KEY_SUFFIX);
                }
                if (props.forceNonDeterministicRendering) {
                    var cachedLayouts = props.contextProvider.get(uniqueKey +
                        Constants_1.Constants.CONTEXT_PROVIDER_LAYOUT_KEY_SUFFIX);
    ...
    RecyclerListView.prototype._checkAndChangeLayouts = function (newProps, forceFullRender) {
        ...
        if (this.props.layoutProvider !== newProps.layoutProvider ||
            ...
            if (newProps.dataProvider.getSize() >
                this.props.dataProvider.getSize()) {
